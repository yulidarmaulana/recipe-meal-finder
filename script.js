    ...
    <div class="col-md-4">
      <div class="card my-1">
        ...
        <div class="card-body">
          ...
          <a href="#" class="btn btn-outline-success my-3 rounded-1 btn-detail" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="${idMeal}">See Detail</a>
        </div>
      </div>
    </div>
    `;
  ...
  function showModal(data) {
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-outline-success" data-bs-dismiss="modal">Close Modal</button>
      </div>
    </div>
    `;
  }
